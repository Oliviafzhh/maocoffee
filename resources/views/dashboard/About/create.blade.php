...
@section('page-title', 'Tambah Gambar About')
...
<div class="p-8 bg-gray-50 min-h-screen">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 border-b border-gray-200 pb-6">
            <div>
                <h2 class="text-3xl font-bold text-gray-800 tracking-tight">Tambah Gambar About</h2>
                <p class="text-gray-500 mt-2 text-sm">Unggah gambar untuk ditampilkan pada bagian About.</p>
            </div>
        </div>
        ...
        <form id="aboutForm" action="{{ route('dashboard.about.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 md:p-8 space-y-8">
                    ...
                    <!-- Upload Gambar -->
                    <div class="space-y-3">
                        <label class="block text-sm font-semibold text-gray-700">Foto About <span class="text-red-500">*</span></label>

                        <div class="relative group">
                            <!-- Area Drag & Drop -->
                            <label for="img_about" class="flex flex-col items-center justify-center w-full h-60 border-2 border-dashed border-[#2E4239]/30 rounded-2xl cursor-pointer bg-[#2E4239]/5 hover:bg-[#2E4239]/10 transition-all duration-300 relative overflow-hidden">
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center z-10" id="upload-placeholder">
                                    ...
                                    <span class="mt-3 px-3 py-1 bg-white text-xs text-gray-500 rounded-full border border-gray-200">JPG, PNG (Max. 2MB)</span>
                                </div>
                                ...
                                <!-- Input -->
                                <input id="img_about" name="img_about" type="file" class="hidden" accept="image/*" required />
                            </label>
                        </div>
                    </div>
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-4 pt-4 border-t border-gray-200">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i> Simpan Gambar About
                </button>
            </div>
...
<script>
    const fileInput = document.getElementById('img_about');
