...
<div class="p-8 bg-gray-50 min-h-screen">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 border-b border-gray-200 pb-6">
            <div>
                <h2 class="text-3xl font-bold text-gray-800 tracking-tight">Manajemen Menu</h2>
                <p class="text-gray-500 mt-2 text-sm">Tambahkan hidangan atau minuman baru ke dalam daftar menu restoran.</p>
            </div>
        </div>
        ...
        <form id="menuForm" action="{{ route('dashboard.menu.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
                ...
                <div class="p-6 md:p-8 space-y-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <select name="kategori" 
                                    ...
                                    <option value="Food" {{ old('kategori') == 'Food' ? 'selected' : '' }}>Makanan (Food)</option>
                                    <option value="Drink" {{ old('kategori') == 'Drink' ? 'selected' : '' }}>Minuman (Drink)</option>
                                    <option value="Snack" {{ old('kategori') == 'Snack' ? 'selected' : '' }}>Cemilan (Snack)</option>
                                </select>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <span class="text-gray-500 font-bold text-sm bg-gray-100 rounded px-2 py-0.5 border border-gray-200 group-focus-within:bg-[#2E4239] group-focus-within:text-white group-focus-within:border-[#2E4239] transition-all shadow-sm">Rp</span>
                                </div>
                                <input type="number" name="harga" value="{{ old('harga') }}" 
                                    class="w-full pl-14 pr-4 py-3.5 bg-gray-50/50 border border-gray-200 rounded-xl text-gray-800 shadow-sm focus:shadow-md focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2E4239]/20 focus:border-[#2E4239] transition-all"
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="deskripsi_menu" rows="4"
                            ...
                            placeholder="Jelaskan detail rasa, bahan utama, atau keunikan menu ini..." required>{{ old('deskripsi_menu') }}</textarea>
                    </div>

                    <!-- Row 4: Upload Gambar (Dipercantik) -->
                    <div class="space-y-3">
                        ...
                        <div class="relative group">
                            ...
                            <label for="img_menu" class="flex flex-col items-center justify-center w-full h-60 border-2 border-dashed border-[#2E4239]/30 rounded-2xl cursor-pointer bg-[#2E4239]/5 hover:bg-[#2E4239]/10 transition-all duration-300 relative overflow-hidden group-hover:border-[#2E4239]/60">
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center z-10 transition-opacity duration-300" id="upload-placeholder">
                                    ...
                                    <span class="mt-3 px-3 py-1 bg-white text-xs text-gray-500 rounded-full border border-gray-200">JPG, PNG, GIF (Max. 2MB)</span>
                                </div>
                                ...
                                <div id="file-info" class="hidden absolute inset-0 bg-white/95 flex flex-col items-center justify-center z-20 backdrop-blur-sm">
                                    ...
                                    <p class="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded">Klik area untuk mengganti</p>
                                </div>

                                <!-- Input File Asli (Hidden) -->
                                <input id="img_menu" name="img_menu" type="file" class="hidden" accept="image/*" required />
                            </label>
                        </div>
                    </div>
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-4 pt-4 border-t border-gray-200">
                ...
                <!-- TOMBOL SIMPAN: Diperbesar & Bayangan Mewah -->
                <button type="submit" 
...
<style>
    /* Animasi bounce kecil untuk icon sukses */
