...
// deteksi SEMUA file upload dari storage
if (
Str::startsWith($path, 'konfigurasi/') ||
Str::startsWith($path, 'konfigurasi_web/')
) {
return asset('storage/' . $path);
}

// File dari seeder (public/image)
return asset($path);
}
                    ...
                    <div class="flex flex-col sm:flex-row gap-10 items-start">
                        ...
                        <div class="shrink-0 relative group">
                            ...
                            <div class="w-40 h-40 rounded-full border-4 border-gray-50 shadow-sm bg-gray-50 flex items-center justify-center overflow-hidden">
                                ...
                                <img src="{{ fileUrl2($konfigurasi->logo_web) }}" class="w-24 h-24 object-contain" alt="Logo">
                                @else
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full">
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <div class="relative w-full aspect-video bg-gray-100 rounded-xl overflow-hidden border border-gray-200 group mb-6">
                            ...
                            <img src="{{ fileUrl2($konfigurasi->img_card1) }}" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" alt="Card 1">
                            @else
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full">
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <div class="relative w-full aspect-video bg-gray-100 rounded-xl overflow-hidden border border-gray-200 group mb-6">
                            ...
                            <img src="{{ fileUrl2($konfigurasi->img_card2) }}" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" alt="Card 2">
                            @else
                            <div class="flex items-center justify-center h-full text-gray-400">
                                <span>No Image</span>
                            </div>
